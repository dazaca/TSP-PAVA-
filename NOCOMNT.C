...
int capt_matr(struct tciudad *pciudad,int *num)
{
 ...
 {
  for(j=0;j<*num;j++)
  fscanf(fich,"%d",&(pciudad->distancia[j]));
  pciudad++;
 }
 fclose(fich);
...
/////////////////////////////////////////////////////////////////////////////
///
/// Funci¢n implementa SIMULATED ANNEALING
///
/////////////////////////////////////////////////////////////////////////////
void sim_annel(int TABU[N],int TABU2[N],unsigned int *suma1)
{
...
int ventana1_2 (int TABU[N],int *NN)
{
 ...
 setcolor(GREEN);
 outtextxy(160,119,"0-Fin recorrido");
 ...
 for(i=0;i<((int)(N/2));i++)
 {
  outtextxy(168,139+(23*i),separador);
  outtextxy(173,139+(23*i),ciudad[i].nombre);
 }
