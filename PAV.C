...
int NN,num,control;
		      // Las variables "NN" y "num" van asociadas al n£mero de
		      // ciudades que ser n escogidas en cada nuevo tour.
		      // "control" ser  empleada para informar en todo momento
		      // de cual debe ser el orden en que se vayan ejecutando
...
long int suma1;   // Es la variable global que ir  pasando y modificando
		      // su valor a trav‚s de distintas funciones pero siempre
		      // informando del kilometraje total del recorrido del
		      // tour que se vaya a seguir.

int TABU[N],TABU2[N]; // Vectores que contendr n los ¡ndices de las ciudades
		      // que han sido seleccionadas para efectuar un tour,
		      // donde TABU2 es empleado de forma auxilier en casos
		      // concretos para efectuar modificaciones sobre un TABU.


// "coord[N][2]" es un array con un n£mero de filas igual al total
// de las ciudades candidatas a ser escogidas para realizar un tour.
// Cada ¡ndice de fila se corresponde con aquel asociado a cada ciudad,
// donde su su correspondiente columna (bien sea la de ¡ndice 0 o 1) da las
...
{                   // varios par metros caracter¡sticos de cada una, como son
...
};                  // el vector de estructuras de nombre "ciudad" y con un
		    // n£mero de elementos igual al total de ciuades.
...
void sim_annel(int TABU[N],int TABU2[N],long int *suma1);
...
////////////////////////////////////////////////////////////////////////////
///Funci¢n que implementa el algoritmo "Simulated Annealing"
///
/////////////////////////////////////////////////////////////////////////////
void sim_annel(int TABU[N],int TABU2[N],long int *suma1)
{
  ...
  int sig = 30;
  int sig2=3;
  char buffer[300],buffer2[1000],dist_TOUR[7];
  long int diff2_1,cont,suma2;
 ...
 while(T>Tmin)
 {
  ...
  for(k=0;k<30000;k++)
  {
   ...
   if(*suma1>30000)
   {
	...
	outtextxy(170,387,ltoa(*suma1,dist_TOUR,10));
...
////////////////////////////////////////////////////////////////////////////
/// Efectua los cambios de arcos por cada dos ciudades. S¢lo ser  empleada
/// dentro de la funci¢n sim_annel().
/////////////////////////////////////////////////////////////////////////////
unsigned int dist_revers(int TABU[N],int TABU2[N])
{
...
/////////////////////////////////////////////////////////////////////////////
/// éltima ventana de confirmaci¢n de salida del programa.
///
///
/////////////////////////////////////////////////////////////////////////////
